...
const EditSection = () => {
        ...
        const fetchInitialData = async () => {
            ...
            try {
                ...
                if (secRes.data.success) {
                    ...
                    setSection({ section_name: sec.section_name, description: sec.description, department: sec.department._id });
                }
    ...
    if (loading) return (
        <div className="text-center mt-10 text-gray-500 animate-pulse">Loading Section Data...</div>
    );
            ...
            <div className="max-w-5xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <div className="lg:col-span-1 bg-white p-6 sm:p-8 rounded-md shadow-md h-fit">
                        <h2 className="text-xl sm:text-2xl font-bold mb-6 text-teal-700">Edit Section</h2>
                    ...
                    <div className="lg:col-span-2 bg-white p-4 sm:p-6 rounded-md shadow-md">
                        <h3 className="text-lg sm:text-xl font-bold mb-4 text-gray-800">
                            Employees in {section.section_name}
                            {employees.length > 0 && (
