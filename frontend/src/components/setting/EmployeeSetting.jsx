...
const EmployeeSetting = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert(err.response?.data?.error || "Server is not responding. Check your backend terminal.");
        }
    };
    ...
    return (
        <div className="p-4 sm:p-6 md:p-8 bg-gray-50 min-h-screen">
            ...
            <div className="max-w-md mx-auto">
                <button onClick={() => navigate('/employee-dashboard')} className="mt-6 text-gray-500 hover:text-black font-semibold flex items-center gap-2 cursor-pointer text-sm">
                    ← Back to Dashboard
                </button>
            </div>
        </div>
